    ...
    public:
        ...
        */
        TebConfig()
        {
            ...
            obstacles.min_obstacle_dist = 0.05;
            obstacles.inflation_dist = 0.06;
            obstacles.dynamic_obstacle_inflation_dist = 0.06;
            obstacles.include_dynamic_obstacles = true;
            obstacles.include_costmap_obstacles = true;
            obstacles.costmap_obstacles_behind_robot_dist = 0.15;
